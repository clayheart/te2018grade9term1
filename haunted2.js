...
console.log();
console.log("*** WELCOME TO THE HAUNTED HOUSE OF COURAGE By CLAY***");
...
if(enterHouse == "y" || enterHouse == "yes") {
 ...
 if(nf == "r"){
console.log("You start to get chased by the shadow figure while running he stabs you and kills you then eats you.)")
}
 if (nf == "a") {
  ...
  if(b == "y" || b == "yes") {
    console.log(`${player.name} turn on  ${player.item} and goes down the basement stairs and finds a chest on the bottom.`)
    c = READLINE.question("Open the chest? (yes or no)")
      ...
      if(c == "y" || c == "yes"){
        ...
        console.log(`${player.name} continues to follow the screams with  new ${player.weapon} and finds an ice monster.`)
       ...
       if(at == "y" || at == "yes"){
        ...
        if(h == "y" || h == "yes"){
          ...
          if(o == "y"|| o == "yes"){
            ...
            console.log(`${player.name} is now a savior and earns the title of 'Demi-God' Good Job you can now slay all mortals?`)
}
}
}
}
